...
// Acid is initialized based on the character, but otherwise has a
// size and position
function Acid(pos, ch) {
  ...
  if (ch == "=") {
    ...
    // Drip acid. Repeat back to this pos.
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  // Handle acid by calling playerTouched
  if (obstacle)
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // if the player touches acid and the player hasn't won
  // Player loses
